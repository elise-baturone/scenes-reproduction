import {
  ...
  SceneCSSGridLayout,
  SceneObject,
  SceneVariableSet, // added
  VariableValueSelectors // added
} from '@grafana/scenes';
...
import {appFilter, dcFilter, marathon_app_idVariable, serviceVariable} from "./Added_Filters"; // added
    ...
    pages: [
      new SceneAppPage({
        ...
        $variables: new SceneVariableSet({
          variables: [appFilter, serviceVariable, dcFilter, marathon_app_idVariable],
        }), // added
